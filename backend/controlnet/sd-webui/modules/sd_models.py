...
def load_model(checkpoint_info=None, already_loaded_state_dict=None):
    ...
    sd_hijack.model_hijack.embedding_load_textual_inversion_embeddings(force_reload=True)  # Reload embeddings after model load as they may or may not fit the model
