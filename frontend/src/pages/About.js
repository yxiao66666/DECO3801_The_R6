...
export default function About() {
    return (
        <>
            <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" /> {/* Stylesheet */}
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <a href="google.comwhat-we-do" className="btn-learn-more" style={{ marginTop: '100px' }}>Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="single_advisor_profile wow fadeInUp" 
                            data-wow-delay="0.2s" 
                            style={{ visibility: 'visible', animationDelay: '0.2s', animationName: 'fadeInUp' }}>
                            <div className="advisor_thumb"><img src="images/william.JPG" alt="william" />
                                <div className="social-info"><a href="google.com"><i className="fa fa-facebook"></i></a><a href="google.com"><i className="fa fa-twitter"></i></a><a href="google.com"><i className="fa fa-linkedin"></i></a></div>
                            </div>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="single_advisor_profile wow fadeInUp" 
                            ...
                            <div className="advisor_thumb"><img src="images/brian.JPG" alt="brian" />
                                <div className="social-info"><a href="google.com"><i className="fa fa-facebook"></i></a><a href="google.com"><i className="fa fa-twitter"></i></a><a href="google.com"><i className="fa fa-linkedin"></i></a></div>
                            </div>
                            <div className="single_advisor_details_info">
                                <h6>Brian Zhang</h6>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="single_advisor_profile wow fadeInUp" 
                            ...
                            <div className="advisor_thumb"><img src="images/ryuto.PNG" alt="ryuto" />
                                <div className="social-info"><a href="google.com"><i className="fa fa-facebook"></i></a><a href="google.com"><i className="fa fa-twitter"></i></a><a href="google.com"><i className="fa fa-linkedin"></i></a></div>
                            </div>
                            <div className="single_advisor_details_info">
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="single_advisor_profile wow fadeInUp" 
                            ...
                            <div className="advisor_thumb"><img src="images/yang.JPG" alt="yang" />
                                <div className="social-info"><a href="google.com"><i className="fa fa-facebook"></i></a><a href="google.com"><i className="fa fa-twitter"></i></a><a href="google.com"><i className="fa fa-linkedin"></i></a></div>
                            </div>
                            <div className="single_advisor_details_info">
                                <h6>Yang Xiao</h6>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="single_advisor_profile wow fadeInUp" 
                            ...
                            <div className="advisor_thumb"><img src="images/shan.jpeg" alt="shan" />
                                <div className="social-info"><a href="google.com"><i className="fa fa-facebook"></i></a><a href="google.com"><i className="fa fa-twitter"></i></a><a href="google.com"><i className="fa fa-linkedin"></i></a></div>
                            </div>
                            <div className="single_advisor_details_info">
                                <h6>Shan Liu</h6>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4">
                        <div className="single_advisor_profile wow fadeInUp" 
                            ...
                            <div className="advisor_thumb"><img src="images/hongyingzi.jpg" alt="hongyingzi" />
                                <div className="social-info"><a href="google.com"><i className="fa fa-facebook"></i></a><a href="google.com"><i className="fa fa-twitter"></i></a><a href="google.com"><i className="fa fa-linkedin"></i></a></div>
                            </div>
                            <div className="single_advisor_details_info">
                                <h6>Hongyingzi Lu</h6>
