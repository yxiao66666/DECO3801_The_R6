    ...
    return (
        <div>
            ...
            <div class="container album py-5 bg-body-tertiary" >
                <p><strong>ArtAssistant</strong> is committed to providing quality services to you and this policy outlines our ongoing obligations to you in respect of how we manage your Personal Information.</p>
                ...
                <h3 class="text-center mb-4">What is Personal Information and why do we collect it?</h3>
                ...
                <p>This Personal Information is obtained in many ways including by email, via our website <strong></strong> and from third parties. We don’t guarantee website links or policy of authorised third parties.</p>
                ...
                <h3 class="text-center mb-4">Sensitive Information</h3>
                ...
                <h3 class="text-center mb-4">Third Parties</h3>
                ...
                <h3 class="text-center mb-4">Disclosure of Personal Information</h3>
                ...
                <h3 class="text-center mb-4">Security of Personal Information</h3>
                ...
                <h3 class="text-center mb-4">Access to your Personal Information</h3>
                ...
                <p><strong>ArtAssistant</strong> will not charge any fee for your access request, but may charge an administrative fee for providing a copy of your Personal Information.</p>
                ...
                <h3 class="text-center mb-4">Maintaining the Quality of your Personal Information</h3>
                ...
                <h3 class="text-center mb-4">Policy Updates</h3>
                <p>This Policy may change from time to time and is available on our website.</p>

                <h3 class="text-center mb-4">Privacy Policy Complaints and Enquiries</h3>
