    ...
    return (
        <div>
            ...
            <div className="container album py-5 bg-body-tertiary" >
                ...
                <h3 className="text-center mb-4">What is Personal Information and why do we collect it?</h3>
                ...
                <h3 className="text-center mb-4">Sensitive Information</h3>
                ...
                <h3 className="text-center mb-4">Third Parties</h3>
                ...
                <h3 className="text-center mb-4">Disclosure of Personal Information</h3>
                ...
                <h3 className="text-center mb-4">Security of Personal Information</h3>
                ...
                <h3 className="text-center mb-4">Access to your Personal Information</h3>
                ...
                <h3 className="text-center mb-4">Maintaining the Quality of your Personal Information</h3>
                ...
                <h3 className="text-center mb-4">Policy Updates</h3>
